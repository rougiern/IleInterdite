...
public class Grille {
    ...
    public ArrayList<Tuile> getTuilesAdjacentesCroixNonCoulees(Tuile tuileCourante) {
        ...
        if(posX!=0){
            if(!(tableau[posX-1][posY].getNom().equals("null")) && tableau[posX-1][posY].getEtat()!=EtatTuile.Coulee){
     ...
     public ArrayList<Tuile> getTuilesAdjacentesCroixInondees(Tuile tuileCourante) {
        ...
        if(posX!=0){
            if(!(tableau[posX-1][posY].getNom().equals("null")) && tableau[posX-1][posY].getEtat()==EtatTuile.Inondee){
                tuilesadj.add(tableau[posX-1][posY]);}}
...
public ArrayList<Tuile> getTuilesNonCoulees() {
    ...
    public ArrayList<Tuile> getTuilesAdjacentes2CasesNonCoulees(Tuile tuileCourante) {
        ...
        if(posY!=0){
         ...
         if(posX>1){
            if(!(tableau[posX-2][posY].getNom().equals("null")) && tableau[posX-2][posY].getEtat()!=EtatTuile.Coulee){
    ...
    public ArrayList<Tuile> getTuilesAdjacentesPlongeur(Tuile tuileCourante) {
        ...
        while (i < tuilesadj.size()) {
            nvtuile.clear();
            if((tuilesadj.get(i).getEtat()==EtatTuile.Coulee || tuilesadj.get(i).getEtat()==EtatTuile.Inondee) && !(tuilesadj.get(i).getNom().equals("null"))){
        ...
        while (x < tuilesadj.size() ) {
            if(tuilesadj.get(x).getEtat()==EtatTuile.Coulee){
                 tuilesadj.remove(x);
            }
             x++;
        }
    ...
    public ArrayList<Tuile> getTuilesAdjacentesCroix(Tuile tuileCourante) {
        ...
        if(posX!=0){
            if(!(tableau[posX-1][posY].getNom().equals("null")) ){
                tuilesadj.add(tableau[posX-1][posY]);}}
        ...
        if(posY!=5){
            if(!(tableau[posX][posY+1].getNom().equals("null")) ){
                tuilesadj.add(tableau[posX][posY+1]);}}
